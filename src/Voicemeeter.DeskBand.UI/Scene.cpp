...
bool Scene::MouseLDouble(const ::linear_algebra::vector& point) {
...
bool Scene::MouseMove(const ::linear_algebra::vector& point) {
	return m_inputTracker->MouseMove(point)
		|| m_pComposition->MouseMove(point);
}
bool Scene::MouseLUp(const ::linear_algebra::vector& point) {
