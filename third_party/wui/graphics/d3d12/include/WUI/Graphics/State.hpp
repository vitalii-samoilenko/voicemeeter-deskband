#ifndef WUI_GRAPHICS_STATE_HPP
#define WUI_GRAPHICS_STATE_HPP
		...
		public:
			inline State(
				...
				if (_layers_size)
				{
					...
					params[1].DescriptorTable.pDescriptorRanges = &hTextureRange;
					params[1].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;
					D3D12_STATIC_SAMPLER_DESC samplerDesc{
				...
				::Microsoft::WRL::ComPtr<ID3DBlob> blenderShader{ nullptr };
				{
					...
					typename TLoader::resource msdfCode{
						loader.LoadResource(
							Layouts::Loader::hlsl::MSDF)
					};
				...
				}
				{
					...
					::Windows::ThrowIfFailed(surface.get_Device()
						->CreateGraphicsPipelineState(
							&pipelineStateDesc,
							IID_PPV_ARGS(&_layers_msdfState)
